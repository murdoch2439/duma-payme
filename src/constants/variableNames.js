...
const API_PAYMENT_INIT =  `http://${ONLINE_BACK_END_PORT}:3000/api/payment-init`
...
const API_CREATE_PAYMENT_INTENT = `http://${ONLINE_BACK_END_PORT}:3000/api/create-payment-intent`
const API_MOBILE_MONEY_PAYMENT_INIT = `http://${ONLINE_BACK_END_PORT}:3000/api/mobile-money-payment`
const HEALTH_CHECK = `http://${ONLINE_BACK_END_PORT}:3000/api/check`
